...
import com.igor.jetpackcompose.view_pager.download.IExecutable;
...
public class PdfConverter implements Runnable {
    ...
    private IExecutable<DownloadFile.FileType> mCallback;
    String mFileType;
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT)
                    ...
                    documentAdapter.onWrite(new PageRange[]{PageRange.ALL_PAGES}, getOutputFileDescriptor(), null, new PrintDocumentAdapter.WriteResultCallback() {
                        ...
                        public void onWriteFinished(PageRange[] pages) {
                            destroy();
                            if (mCallback != null) {
                                mCallback.execute(DownloadFile.Companion.getType(mFileType));
                            }
                        }
                    });
                }
    ...
    public void convert(Context context, String htmlString, File file, IExecutable<DownloadFile.FileType> callback, String fileType) {
        if (context == null)
